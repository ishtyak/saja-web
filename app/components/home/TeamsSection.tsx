      ...
      <div className="max-w-360 mx-auto px-8 lg:px-16">
        <div className="flex justify-center">
          <div className=" text-center">
            ...
            <p className="text-[24px] text-[#494949] mb-16 max-w-4xl text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 ">
          ...
          <div className="flex flex-col gap-16">
            <div className="border border-gray-200 rounded-2xl p-8">
              <button className="text-[24px] font-bold text-black mb-4 bg-[#F9BE00] rounded-full px-3">Collaborator</button>
              ...
              <p className="text-[20px] text-[#494949] mt-2">
                Built for market research, on-ground studies, and large-scale data collection.
              </p>
            </div>

            <div className="border border-gray-200 rounded-2xl p-8">
              <button className="text-[24px] font-bold text-black mb-4 bg-[#F9BE00] rounded-full px-3">Interviewer</button>
              <p className="text-[20px] text-[#494949] mb-4">
