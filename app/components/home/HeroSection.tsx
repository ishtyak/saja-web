  ...
  return (
    <section className="w-full bg-white">
      ...
      <div id="features" className="w-full bg-[#f5a623] ">
        <p className="text-center text-white text-[40px] font-bold">What we do?</p>
        <p className="text-center text-black text-[36px] font-bold ">Design. Collect. Analyse. All in one platform.</p>
      </div>
